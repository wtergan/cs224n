...
def train(parser, train_data, dev_data, output_path, batch_size=1024, n_epochs=10, lr=0.0005):
    ...
    # Implementation of the Adam optimizer, used for parameter optimization, as well as cross entropy loss initialization.
...
def train_for_epoch(parser, train_data, dev_data, optimizer, loss_func, batch_size):
    ...
    with tqdm(total=(n_minibatches)) as prog:
        for i, (train_x, train_y) in enumerate(minibatches(train_data, batch_size)):
            ...
            """
            - Using the training data into the model to produce the logits.
            - Use the logits to compute the cross entropy loss.
            - Backpropagate through the model.
            - After backprop, optimize using the optimizer (updating of parameters using gradients from backprop).
            """
