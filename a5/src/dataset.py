...
class NameDataset(Dataset):
    def __init__(self, pretraining_dataset, data):
        ...
        self.itos = pretraining_dataset.itos  # index-to-string dictionary
        self.stoi = pretraining_dataset.stoi # string-to-index dictionary
        self.block_size = pretraining_dataset.block_size # the block size
        # the raw text data which is preprocessed via removal of non-ASCII characters, as well as
        # the splitting of the text into lines.
    ...
    def __getitem__(self, idx):
        # returns (x, y) pair of input-output tensors via the splitting of data at tab, masking and 
        # padding sequences, and mapping chars to indices.
